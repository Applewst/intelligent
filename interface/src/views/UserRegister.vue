    ...
    <div class="right-panel">
      <el-card class="form-card">
        ...
        >
          ...
          <!-- 登录按钮 -->
          <el-form-item>
            <el-button type="primary" class="login-btn" @click="handleSubmit(loginRef)"
              >登 录</el-button
            >
          </el-form-item>
        </el-form>
        ...
        <!-- 注册表单 -->
        <el-form :model="registerForm" :rules="registerRules" ref="registerRef" v-else>
          <!-- 用户名输入框 -->
          <el-form-item prop="username">
            <el-input
          ...
          <!-- 注册按钮 -->
          <el-form-item>
            <el-button type="primary" class="login-btn" @click="handleSubmit(registerRef)"
              >注 册</el-button
            >
          </el-form-item>
        </el-form>
